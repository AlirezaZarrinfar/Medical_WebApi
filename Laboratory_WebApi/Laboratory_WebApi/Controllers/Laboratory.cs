...
namespace Laboratory_WebApi.Controllers
{
    ...
    public class Laboratory : ControllerBase
    {
        ...
        [HttpPost("SubTest")]
        public async Task<IActionResult> AddSubTest(SubTestsModel model)
        {
        ...
        [HttpPut("SubTest")]
        public async Task<IActionResult> UpdateSubTest(SubTestsModel model)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest();
        ...
        [HttpPost("TestGroup")]
        public async Task<IActionResult> AddTestGroup(TestGroupModel model)
        {
            if (!ModelState.IsValid)
            {
        ...
        [HttpPut("TestGroup")]
        public async Task<IActionResult> UpdateTestGroup(TestGroupModel model)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest();
